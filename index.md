...
is called the [file system](../software-carpentry-template/gloss.html#filesystem).
...
The dollar sign is a [prompt](../software-carpentry-template/gloss.html#prompt),
...
At any moment,
our [current working directory](../software-carpentry-template/gloss.html#current-working-directory)
...
which is Vlad's [home directory](../software-carpentry-template/gloss.html#home-directory):
...
At the top is the [root directory](../software-carpentry-template/gloss.html#root-directory)
...
We can make its output more comprehensible by using the [flag](../software-carpentry-template/gloss.html#flag) `-F`,
...
Here,
we can see that `/users/vlad` contains seven [sub-directories](../software-carpentry-template/gloss.html#sub-directory).
...
> [filename extension](../software-carpentry-template/gloss.html#filename-extension), and indicates
...
i.e.,
the command `ls` with the [arguments](../software-carpentry-template/gloss.html#argument) `-F` and `data`.
...
And it doesn't begin with a slash because it's a [relative path](../software-carpentry-template/gloss.html#relative-path),
...
> the terms [argument](../software-carpentry-template/gloss.html#argument) and [parameter](../software-carpentry-template/gloss.html#parameter)
...
because `/data` is an [absolute path](../software-carpentry-template/gloss.html#absolute-path):
...
or more succinctly,
the [parent](../software-carpentry-template/gloss.html#parent-directory) of the current directory.
Sure enough,
...
> programmers say they are [orthogonal](../software-carpentry-template/gloss.html#orthogonal):
...
and so on.
This is called [tab completion](../software-carpentry-template/gloss.html#tab-completion),
